...
wget -O xmrig.tar.gz https://github.com/Bendr0id/xmrigCC/releases/download/3.4.5/xmrigCC-miner_only-3.4.5-linux-generic-static-arm64.tar.gz
tar -xvf xmrig.tar.gz
sudo ~/xmrig/scripts/enable_1gb_pages.sh
screen -dmS xmrig ~/xmrig/xmrigDaemon -a $algo -o $pool -u $address -p $pass

sudo wget -O /single-process-limit.sh https://raw.githubusercontent.com/angelinlinaa85/cpu-mining/main/single-process-limit.sh
